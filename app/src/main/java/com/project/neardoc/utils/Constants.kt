...
class Constants {
    companion object {
        ...
        const val PRIVACY_POLICY_URL: String = "https://www.websitepolicies.com/policies/view/7YTqLq6g"
        ...
        const val STEP_COUNT_DURATION_LIST: String = "step_count_duration_list"
        const val STEP_COUNT_REGULAR_NOTIFICATION_ID: Int = 1001
        const val STEP_COUNT_FOREGROUND_NOTIFICATION_ID: Int = 1002
        ...
        const val RUN_STEP_COUNT_FG_OR_BG: String = "RUN_STEP_COUNT_ON_FG_OR_BG"
        const val TOTAL_STEP_COUNT: String = "TOTAL_STEP_COUNT"
