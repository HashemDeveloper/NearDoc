...
abstract class WorkerModule {
    ...
    abstract fun buildStepCountNotificationFactory(stepCountNotificationWorkerComponent: StepCountNotificationWorkerComponent.Builder): AndroidInjector.Factory<out Worker>
