...
@LargeTest
class DeleteAccountWorkerWrongEmailTest {
    ...
    @Test
    fun deleteAccount_appProvider_failedWrongEmail() {
        val authKey: String = this.context.resources.getString(R.string.firebase_web_key)
        val email = "juniayula@outlook.com"
        ...
        val request: OneTimeWorkRequest =
            OneTimeWorkRequest.Builder(DeleteAccountWorker::class.java)
        ...
        assertThat(
            message,
            `is`("There is no user record corresponding to this identifier. The user may have been deleted.")
        )
    }
}